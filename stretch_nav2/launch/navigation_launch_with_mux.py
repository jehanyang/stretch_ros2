...
This is a modified version of navigation_launch.py that adds a cmd_vel_mux node
between Nav2's controller_server and the stretch_driver. This allows you to
pause/resume Nav2 velocity commands via a service.
...
def generate_launch_description():
    ...
    # Controller publishes to /nav2/cmd_vel instead of /stretch/cmd_vel
    # The mux node will forward to /stretch/cmd_vel when enabled
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[{
                ...
                'output_topic': '/stretch/cmd_vel',
                'enabled': nav2_enabled,
            }]),
